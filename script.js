...
const displayMovements = function (movements) {
    ...
    if (movements.length === 0) {
        ...
        movements.forEach(item => {
            ...
            <div class="edits">
                <button class="edit" onclick=edits(${item.id})><i class="fa fa-edit" id="edit-a" style="display: ${searched && text.value.trim() || editFlag ? 'none' : ''};"></i></button>
                <button class="delete" onclick=deletes(${item.id})><i class="fa-solid fa-delete-left deletebtn" style="display: ${searched && text.value.trim() || editFlag ? 'none' : ''};"></i></button>
